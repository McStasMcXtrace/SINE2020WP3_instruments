...
%folder_name = 'Fe_cementite_Fe304' % 5 min
folder_name = 'Powder_bug_fixed_cementite_oxygen_2' % 5 min


monitor_names = {'Fe_alpha_L.dat' 'cementite_L.dat' 'Fe3O4_L.dat'};
...
powder_data{3} = importdata('Fe3O4_mp-19306_computed.laz',' ',48)


power_fraction(1)=0.01;
power_fraction(2)=0.01;
power_fraction(3)=0.01;
